    ...
    <>
      ...
      <div className="mt-8 space-y-9 text-sm leading-relaxed text-slate-300">
        ...
        <section>
          ...
          <p className="mt-2"><b>End-to-end encryption (optional).</b> Direct (one-to-one) chats become end-to-end encrypted once both people have set up encryption on their devices: keys are generated on your device and we store only public keys and ciphertext, so we cannot read that content. Until encryption is established for a chat — and for <b>group chats and channels</b>, and for messages sent before encryption was enabled — message content is stored on our servers in readable form, protected by encryption in transit and database access controls but not by end-to-end encryption. Enabling encryption does not retroactively encrypt earlier messages. <b>Media attachments</b> (images, videos, files) are stored on our servers with access controls and are <b>not</b> end-to-end encrypted. If you lose your device and have not saved a passphrase backup of your key, your encrypted history may be unrecoverable.</p>
        </section>
        <section>
